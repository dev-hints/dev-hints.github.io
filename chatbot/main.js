...
$(function () {
    ...
    function send() {
        ...
        10 > t ? t = "0" + t : t = t;
        12 > h ? time = h + ":" + t + " am" : time = (h - 12) + ":" + t + " pm";
        var hello = ["HELLO", "HI", "HELLO HACKET", "HEY THERE", "HEY", "HI DUDE", "HI HACKET", "HELLO HACKET", "HI AYUSH"];
        var gm = ["GM", "GOOD MORNING", "GOOD MORNING Hacket", "GOOD MORNING AYUSH"];
        var bad = ["BAD", "NOT BAD", "USELESS", "NOT WORKING", "NOT GOOD"];
        var ge = ["GOOD EVNG", "GOOD EVENING", "GOOD EVENING HACKET", "GOOD EVENING DEAR"];
        ...
        var gaf = ["GOOD AFTERNOON", "GOOD AFTERNOON AYUSH", "GOOD AFTERNOON HACKET"];
